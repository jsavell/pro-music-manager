...
if (!empty($versions)) {
	foreach ($versions as $version) {
		echo "	<option disabled value=\"{$version['id']}\">{$version['name']}</option>";
	}
}
echo '		</select>
...
if (!empty($libraries)) {
	foreach ($libraries as $library) {
		echo "	<option disabled value=\"{$library['id']}\">{$library['name']}</option>";
	}
}
echo '		</select>
			</div>
